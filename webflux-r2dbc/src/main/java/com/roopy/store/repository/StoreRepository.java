...
public interface StoreRepository extends ReactiveCrudRepository<Store1,Integer> {
    ...
    Flux<Store1> findStoresByPointWithRadius(@Param("lat") double lat, @Param("lot") double lot, @Param("radius") int radius);
}