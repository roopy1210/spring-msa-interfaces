...
public interface StoreRepository extends JpaRepository<Store2,Integer> {
    ...
    @Query(value = "select s.id"                                                                                                    +
         ...
         , nativeQuery = true)
    List<Store2> findStoresByPointWithRadius(@Param("lat") double lat, @Param("lot") double lot, @Param("radius") double radius);
}